...
\title{Feasible Actuator Range Modifier (FARM) User Manual \\
        \large Supervisory Control plugin for RAVEN \\
        \large FARM-UM-1 \\
}%\author{%
...
\begin{document}
    ...
    \input{include/InputExample.tex}
