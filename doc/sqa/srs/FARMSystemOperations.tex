...
%
% REPLACE THIS ITEM WITH THE ONE ABOVE ONCE THE FARM GETS OPENSOURCE
%
%The FARM plug-in in its entirety will be made available on an appropriate protected repository hosting site (i.e. INL GITLAB).
%Backups and security services will be provided by the hosting service.
